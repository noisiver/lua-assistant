...
-- Containers
UPDATE `item_template` SET `BuyPrice`=0, `SellPrice`=0 WHERE `entry` IN (23162, 41597, 44447, 44448);
DELETE FROM `npc_vendor` WHERE `entry`=@Entry+30;
INSERT INTO `npc_vendor` (`entry`, `item`) VALUES (@Entry+30, 23162); -- Foror's Crate of Endless Resist Gear Storage (36-slot Bag)
INSERT INTO `npc_vendor` (`entry`, `item`) VALUES (@Entry+30, 41597); -- Abyssal Bag (32-slot Soul Bag)
INSERT INTO `npc_vendor` (`entry`, `item`) VALUES (@Entry+30, 44447); -- Abyssal Bag (28-slot Ammo Pouch)
INSERT INTO `npc_vendor` (`entry`, `item`) VALUES (@Entry+30, 44448); -- Nerubian Reinforced Quiver (28-slot Quiver)
